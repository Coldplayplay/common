...
main (int argc, char ** argv)
{
  ...
  if (cloud->isOrganized ())
  {
    ...
    pcl::io::savePCDFileBinary("supervoxel_seg_result.pcd", *full_labeled_cloud);
    pcl::io::savePCDFileBinary("refined_supervoxel_seg_result.pcd", *refined_full_labeled_cloud);
  }
