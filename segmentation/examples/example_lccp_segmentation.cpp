...
/// -----------------------------------|  Main Computation  |-----------------------------------
  ...
  // Supervoxel Stuff
  float voxel_resolution = 0.008f;//   -v 0.0075f
  float seed_resolution = 0.08f;//   	-s 0.03f
  float color_importance =0.2f;//	  -c 0.0f
  float spatial_importance = 0.4f;//	-z 1.0f
  float normal_importance = 1.0f;//	-n 4.0f
  bool use_single_cam_transform = false;
  bool use_supervoxel_refinement = false;

  // LCCPSegmentation Stuff
  float concavity_tolerance_threshold = 10;//	-ct
  float smoothness_threshold = 0.1;//		-st
  uint32_t min_segment_size = 0;//		-smooth
  bool use_extended_convexity = false;//	-ec
  bool use_sanity_criterion = false;//		-sc
